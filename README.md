...
Если вы видите ошибку про @rollup/rollup-linux-x64-musl — это не ваша вина. Это вина npm.
Я тоже плакал. Держитесь.
...
“Создал e-commerce архитектуру с нуля, без Docker-опыта, на Windows,
с 9 днями молитв и 17 попытками установить esbuild-wasm.” 
